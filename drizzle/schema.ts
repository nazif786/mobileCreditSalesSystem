...
export const companyContacts = mysqlTable(
  ...
  (table) => {
    return {
      ...
      companyContactsContId: primaryKey({
        columns: [table.contId],
...
export const customerSales = mysqlTable(
  ...
  (table) => {
    return {
      ...
      customerSalesSaleId: primaryKey({
...
export const customers = mysqlTable(
  "customers",
  {
    ...
    custRegDate: datetime("cust_reg_date", { mode: "string" }).default(
...
export const employees = mysqlTable(
  "employees",
  {
    ...
    regDate: datetime("reg_date", { mode: "string" })
...
export const invoicePictures = mysqlTable(
  "invoice_pictures",
  {
    picId: int("pic_id").autoincrement().notNull(),
    pId: int("p_id").references(() => purchases.pId),
    picDate: datetime("pic_date", { mode: "string" }).default(
      sql`CURRENT_TIMESTAMP`,
    ),
    picInvoiceDate: datetime("pic_invoice_date", { mode: "string" }).default(
      sql`CURRENT_TIMESTAMP`,
    ),
  ...
  (table) => {
    return {
      invoicePictureCompanyFkIdx: index("invoice_picture_company_fk_idx").on(
        table.compId,
      ),
      invoicePicturesPicId: primaryKey({
        columns: [table.picId],
...
export const purchasechanges = mysqlTable(
  "purchasechanges",
  {
    ...
    changedAt: timestamp("changedAt", { mode: "string" })
      .default(sql`CURRENT_TIMESTAMP`)
      .notNull(),
  },
  (table) => {
    return {
      purchasechangesPChangeId: primaryKey({
        columns: [table.pChangeId],
...
export const purchasedelete = mysqlTable(
  "purchasedelete",
  {
  ...
  (table) => {
    return {
      purchasedeleteDeleteId: primaryKey({
        columns: [table.deleteId],
...
export const saleschanges = mysqlTable(
  "saleschanges",
  {
  ...
  (table) => {
    return {
      saleschangesChangeId: primaryKey({
...
export const salesdelete = mysqlTable(
  "salesdelete",
  {
  ...
  (table) => {
    return {
      salesdeleteSaleDeleteId: primaryKey({
        columns: [table.saleDeleteId],
...
export const transactionType = mysqlTable(
  "transaction_type",
  {
  ...
  (table) => {
    return {
      transactionTypeTypeId: primaryKey({
...
export const users = mysqlTable(
  "users",
  {
    ...
    empId: int("emp_id").references(() => employees.id, {
      onDelete: "restrict",
      onUpdate: "cascade",
    }),
...
export type SelectSales = InferSelectModel<typeof customerSales>;
export type InsertSales = InferInsertModel<typeof customerSales>;
